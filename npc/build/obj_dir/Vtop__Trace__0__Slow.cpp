...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+137,"type_J", false,-1);
    ...
    tracep->declBus(c+145,"len", false,-1, 2,0);
    tracep->declBit(c+146,"signalsig", false,-1);
    ...
    tracep->declBus(c+211,"INPUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+205,"OUTPUT_WIDTH", false,-1, 31,0);
    ...
    tracep->declBus(c+103,"src1", false,-1, 4,0);
    tracep->declBus(c+104,"src2", false,-1, 4,0);
    tracep->declBus(c+147,"csr", false,-1, 11,0);
    ...
    tracep->declBus(c+148,"csr_choose", false,-1, 1,0);
    ...
    tracep->declBus(c+147,"key", false,-1, 11,0);
    ...
    tracep->declBus(c+149,"lut_out", false,-1, 1,0);
    ...
    tracep->declBus(c+222,"tmp", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+116,(vlSelf->top__DOT__jalsig));
    ...
    bufp->fullBit(oldp+137,((0x6fU == (0x7fU & vlSelf->top__DOT__infetch0__DOT__reg_inst))));
    bufp->fullIData(oldp+138,(vlSelf->top__DOT__decoder0__DOT__I_imm),32);
    bufp->fullIData(oldp+139,((0xfffff000U & vlSelf->top__DOT__infetch0__DOT__reg_inst)),32);
    bufp->fullIData(oldp+140,(vlSelf->top__DOT__decoder0__DOT__S_imm),32);
    bufp->fullIData(oldp+141,(vlSelf->top__DOT__decoder0__DOT__J_imm),32);
    bufp->fullIData(oldp+142,(vlSelf->top__DOT__decoder0__DOT__B_imm),32);
    bufp->fullBit(oldp+143,(((0x67U == (0x7fU & vlSelf->top__DOT__infetch0__DOT__reg_inst)) 
                             | ((IData)(vlSelf->top__DOT__jalsig) 
                                | (0x17U == (0x7fU 
                                             & vlSelf->top__DOT__infetch0__DOT__reg_inst))))));
    bufp->fullBit(oldp+144,((0x37U == (0x7fU & vlSelf->top__DOT__infetch0__DOT__reg_inst))));
    bufp->fullCData(oldp+145,(vlSelf->top__DOT__mem0__DOT__len),3);
    bufp->fullBit(oldp+146,(vlSelf->top__DOT__mem0__DOT__signalsig));
    bufp->fullSData(oldp+147,((vlSelf->top__DOT__infetch0__DOT__reg_inst 
                               >> 0x14U)),12);
    bufp->fullCData(oldp+148,(vlSelf->top__DOT__regfile__DOT__csr_choose),2);
    bufp->fullCData(oldp+149,(vlSelf->top__DOT__regfile__DOT__muxcsr__DOT__i0__DOT__lut_out),2);
    bufp->fullBit(oldp+150,(vlSelf->top__DOT__regfile__DOT__muxcsr__DOT__i0__DOT__hit));
    ...
    bufp->fullQData(oldp+154,(vlSelf->top__DOT__chosmuximm__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+156,(vlSelf->top__DOT__chosmuximm__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+158,(vlSelf->top__DOT__chosmuximm__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+159,(vlSelf->top__DOT__chosmuximm__DOT__i0__DOT__data_list[1]),32);
    ...
    __Vtemp_h999ddfee__0[4U] = (vlSelf->top__DOT__res 
                                >> 0x17U);
    bufp->fullWData(oldp+160,(__Vtemp_h999ddfee__0),140);
    bufp->fullQData(oldp+165,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+167,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+169,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+171,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullIData(oldp+173,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+174,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+175,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+176,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+177,(vlSelf->top__DOT__alu0__DOT__A_s),32);
    ...
    bufp->fullBit(oldp+181,((vlSelf->top__DOT__res 
                             >> 0x1fU)));
    bufp->fullBit(oldp+182,(vlSelf->top__DOT__alu0__DOT__carry_tmp));
    bufp->fullIData(oldp+183,(vlSelf->top__DOT__res),32);
    bufp->fullIData(oldp+184,(vlSelf->top__DOT__alu0__DOT__logres),32);
    bufp->fullIData(oldp+185,(vlSelf->top__DOT__alu0__DOT__addres),32);
    bufp->fullBit(oldp+186,((0U == vlSelf->top__DOT__alu0__DOT__addres)));
    bufp->fullIData(oldp+187,(vlSelf->top__DOT__alu0__DOT__shfres),32);
    bufp->fullIData(oldp+188,(vlSelf->top__DOT__alu0__DOT__sltres),32);
    bufp->fullIData(oldp+189,(vlSelf->top__DOT__chosmuximm__DOT__i0__DOT__lut_out),32);
    bufp->fullIData(oldp+190,(vlSelf->top__DOT__npc),32);
    bufp->fullIData(oldp+191,(vlSelf->top__DOT__pcaddimmbridge),32);
    bufp->fullIData(oldp+192,(vlSelf->top__DOT__pcwritereg),32);
    bufp->fullIData(oldp+193,(vlSelf->top__DOT__regwrite),32);
    bufp->fullIData(oldp+194,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+195,(vlSelf->top__DOT__muxpc__DOT__i0__DOT__hit));
    ...
    bufp->fullIData(oldp+199,(vlSelf->top__DOT__pcbridge),32);
    bufp->fullIData(oldp+200,(((IData)(4U) + vlSelf->top__DOT__pcbridge)),32);
    bufp->fullIData(oldp+201,(vlSelf->top__DOT__memread),32);
    bufp->fullIData(oldp+202,(vlSelf->top__DOT__mem0__DOT__read_s),32);
    ...
    bufp->fullIData(oldp+214,(0x23U),32);
    ...
    bufp->fullIData(oldp+222,(vlSelf->top__DOT__regfile__DOT__registers0__DOT__tmp),32);
}
