...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+140,"rready", false,-1, 1,0);
    tracep->declBus(c+139,"bready", false,-1, 1,0);
    tracep->declBus(c+141,"bvalid", false,-1, 1,0);
    tracep->declBus(c+142,"rvalid", false,-1, 1,0);
    tracep->declBus(c+143,"awready", false,-1, 1,0);
    tracep->declBus(c+143,"wready", false,-1, 1,0);
    tracep->declBus(c+143,"arready", false,-1, 1,0);
    for (int i = 0; i < 2; ++i) {
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+148+i*1,"wstrb", true,(i+0), 3,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBit(c+150+i*1,"bresp", true,(i+0));
    }
    ...
    tracep->declBus(c+140,"rready_in", false,-1, 1,0);
    tracep->declBus(c+139,"bready_in", false,-1, 1,0);
    tracep->declBus(c+142,"rvalid_out", false,-1, 1,0);
    tracep->declBus(c+143,"awready_out", false,-1, 1,0);
    tracep->declBus(c+143,"wready_out", false,-1, 1,0);
    tracep->declBus(c+143,"arready_out", false,-1, 1,0);
    tracep->declBus(c+141,"bvalid_out", false,-1, 1,0);
    tracep->declBit(c+152,"awvalid_sram", false,-1);
    tracep->declBit(c+153,"wvalid_sram", false,-1);
    tracep->declBit(c+154,"arvalid_sram", false,-1);
    tracep->declBit(c+155,"rready_sram", false,-1);
    tracep->declBit(c+152,"bready_sram", false,-1);
    tracep->declBit(c+156,"rvalid_sram", false,-1);
    tracep->declBit(c+157,"awready_sram", false,-1);
    tracep->declBit(c+157,"wready_sram", false,-1);
    tracep->declBit(c+157,"arready_sram", false,-1);
    ...
    tracep->declBus(c+158,"wstrb_sram", false,-1, 3,0);
    tracep->declBit(c+159,"bresp_sram", false,-1);
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declBit(c+162+i*1,"bresp", true,(i+0));
    }
    tracep->declBit(c+152,"awvalid_out", false,-1);
    tracep->declBit(c+153,"wvalid_out", false,-1);
    tracep->declBit(c+154,"arvalid_out", false,-1);
    tracep->declBit(c+155,"rready_out", false,-1);
    tracep->declBit(c+152,"bready_out", false,-1);
    tracep->declBit(c+294,"bvalid_in", false,-1);
    tracep->declBit(c+156,"rvalid_in", false,-1);
    tracep->declBit(c+157,"awready_in", false,-1);
    tracep->declBit(c+157,"wready_in", false,-1);
    tracep->declBit(c+157,"arready_in", false,-1);
    ...
    tracep->declBus(c+158,"wstrb_out", false,-1, 3,0);
    tracep->declBus(c+259,"rdata_in", false,-1, 31,0);
    tracep->declBit(c+159,"bresp_in", false,-1);
    tracep->declBit(c+164,"busy", false,-1);
    tracep->declBus(c+165,"giant", false,-1, 1,0);
    ...
    tracep->declBus(c+158,"wstrb_out_reg", false,-1, 3,0);
    tracep->declBus(c+295,"j", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("mem0 ");
    tracep->declBit(c+290,"clk", false,-1);
    tracep->declBit(c+152,"awvalid", false,-1);
    tracep->declBit(c+157,"awready", false,-1);
    tracep->declBus(c+256,"awaddr", false,-1, 31,0);
    tracep->declBit(c+153,"wvalid", false,-1);
    tracep->declBit(c+157,"wready", false,-1);
    tracep->declBus(c+258,"wdata", false,-1, 31,0);
    tracep->declBus(c+158,"wstrb", false,-1, 3,0);
    tracep->declBit(c+294,"bvalid", false,-1);
    tracep->declBit(c+152,"bready", false,-1);
    tracep->declBit(c+159,"bresp", false,-1);
    tracep->declBit(c+154,"arvalid", false,-1);
    tracep->declBit(c+157,"arready", false,-1);
    tracep->declBus(c+257,"araddr", false,-1, 31,0);
    tracep->declBit(c+155,"rready", false,-1);
    tracep->declBit(c+156,"rvalid", false,-1);
    tracep->declBus(c+259,"rdata", false,-1, 31,0);
    tracep->declBus(c+167,"state", false,-1, 1,0);
    tracep->declBus(c+108,"random_delay", false,-1, 3,0);
    tracep->declBit(c+168,"busy", false,-1);
    tracep->declBus(c+169,"random_count", false,-1, 3,0);
    tracep->declBus(c+170,"memmask", false,-1, 2,0);
    ...
    tracep->declBus(c+108,"out", false,-1, 3,0);
    tracep->declBus(c+109,"random_num", false,-1, 7,0);
    tracep->declBit(c+110,"feedback", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+158,"key", false,-1, 3,0);
    ...
    tracep->declBit(c+125,"arvalid", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+108,((0xfU & (IData)(vlSelf->top__DOT__data0__DOT__mem0__DOT__lsfr0__DOT__random_num))),4);
    bufp->fullCData(oldp+109,(vlSelf->top__DOT__data0__DOT__mem0__DOT__lsfr0__DOT__random_num),8);
    bufp->fullBit(oldp+110,((1U & VL_REDXOR_8((0xb8U 
    ...
    bufp->fullCData(oldp+142,(vlSelf->top__DOT__data0__DOT__rvalid_out),2);
    ...
    bufp->fullCData(oldp+144,(vlSelf->top__DOT__wstrb[0]),4);
    bufp->fullCData(oldp+145,(vlSelf->top__DOT__wstrb[1]),4);
    bufp->fullBit(oldp+146,(vlSelf->top__DOT__bresp[0]));
    bufp->fullBit(oldp+147,(vlSelf->top__DOT__bresp[1]));
    bufp->fullCData(oldp+148,(vlSelf->top__DOT____Vcellinp__data0__wstrb[0]),4);
    bufp->fullCData(oldp+149,(vlSelf->top__DOT____Vcellinp__data0__wstrb[1]),4);
    bufp->fullBit(oldp+150,(vlSelf->top__DOT____Vcellout__data0__bresp[0]));
    bufp->fullBit(oldp+151,(vlSelf->top__DOT____Vcellout__data0__bresp[1]));
    bufp->fullBit(oldp+152,(vlSelf->top__DOT__data0__DOT__awvalid_sram));
    bufp->fullBit(oldp+153,(vlSelf->top__DOT__data0__DOT__wvalid_sram));
    bufp->fullBit(oldp+154,(vlSelf->top__DOT__data0__DOT__arvalid_sram));
    bufp->fullBit(oldp+155,((0U != ((IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__giant) 
                                    & (IData)(vlSelf->top__DOT__data0__DOT__arvalid_in)))));
    bufp->fullBit(oldp+156,((1U == (IData)(vlSelf->top__DOT__data0__DOT__mem0__DOT__state))));
    bufp->fullBit(oldp+157,(((~ (IData)(vlSelf->top__DOT__data0__DOT__mem0__DOT__busy)) 
                             & (0U == (IData)(vlSelf->top__DOT__data0__DOT__mem0__DOT__state)))));
    bufp->fullCData(oldp+158,(vlSelf->top__DOT__data0__DOT__arviter0__DOT__wstrb_out_reg),4);
    bufp->fullBit(oldp+159,((2U == (IData)(vlSelf->top__DOT__data0__DOT__mem0__DOT__state))));
    bufp->fullCData(oldp+160,(vlSelf->top__DOT__data0__DOT____Vcellinp__arviter0__wstrb[0]),4);
    bufp->fullCData(oldp+161,(vlSelf->top__DOT__data0__DOT____Vcellinp__arviter0__wstrb[1]),4);
    bufp->fullBit(oldp+162,(vlSelf->top__DOT__data0__DOT____Vcellout__arviter0__bresp[0]));
    bufp->fullBit(oldp+163,(vlSelf->top__DOT__data0__DOT____Vcellout__arviter0__bresp[1]));
    bufp->fullBit(oldp+164,(vlSelf->top__DOT__data0__DOT__arviter0__DOT__busy));
    bufp->fullCData(oldp+165,(vlSelf->top__DOT__data0__DOT__arviter0__DOT__giant),2);
    bufp->fullIData(oldp+166,(vlSelf->top__DOT__data0__DOT__arviter0__DOT__i),32);
    bufp->fullCData(oldp+167,(vlSelf->top__DOT__data0__DOT__mem0__DOT__state),2);
    bufp->fullBit(oldp+168,(vlSelf->top__DOT__data0__DOT__mem0__DOT__busy));
    bufp->fullCData(oldp+169,(vlSelf->top__DOT__data0__DOT__mem0__DOT__random_count),4);
    bufp->fullCData(oldp+170,(vlSelf->top__DOT__data0__DOT__mem0__DOT__memmask),3);
