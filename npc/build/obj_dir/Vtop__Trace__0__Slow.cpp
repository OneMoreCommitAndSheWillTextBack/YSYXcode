...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+118,"aluopcode", false,-1, 4,0);
    ...
    tracep->declBus(c+118,"op", false,-1, 4,0);
    tracep->declBus(c+183,"res", false,-1, 31,0);
    tracep->declBit(c+187,"zero", false,-1);
    tracep->declBit(c+188,"signal", false,-1);
    tracep->declBit(c+189,"carry", false,-1);
    tracep->declBit(c+119,"addsig", false,-1);
    tracep->declBit(c+120,"logsig", false,-1);
    tracep->declBit(c+121,"shfsig", false,-1);
    tracep->declBit(c+122,"sltsig", false,-1);
    tracep->declBit(c+189,"carry_tmp", false,-1);
    tracep->declBit(c+123,"type_I", false,-1);
    ...
    tracep->declBus(c+118,"aluopcode", false,-1, 4,0);
    tracep->declBit(c+123,"type_I", false,-1);
    tracep->declBit(c+124,"type_B", false,-1);
    tracep->declBit(c+125,"type_R", false,-1);
    tracep->declBit(c+126,"addsig", false,-1);
    tracep->declBus(c+127,"branchop", false,-1, 3,0);
    tracep->declBus(c+128,"IRop", false,-1, 3,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declArray(c+149,"lut", false,-1, 65,0);
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declQuad(c+152+i*2,"pair_list", true,(i+0), 32,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+1+i*1,"key_list", true,(i+0), 0,0);
    }
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+156+i*1,"data_list", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+98,"src2", false,-1, 4,0);
    tracep->declBus(c+99,"rd", false,-1, 4,0);
    tracep->declBit(c+131,"type_I", false,-1);
    tracep->declBit(c+132,"type_R", false,-1);
    tracep->declBit(c+133,"type_U", false,-1);
    tracep->declBit(c+105,"type_S", false,-1);
    tracep->declBit(c+112,"type_J", false,-1);
    tracep->declBit(c+111,"type_B", false,-1);
    tracep->declBus(c+134,"I_imm", false,-1, 31,0);
    tracep->declBus(c+135,"U_imm", false,-1, 31,0);
    tracep->declBus(c+136,"S_imm", false,-1, 31,0);
    tracep->declBus(c+137,"J_imm", false,-1, 31,0);
    tracep->declBus(c+138,"B_imm", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+139,"regwritepc", false,-1);
    tracep->declBit(c+106,"regwritemem", false,-1);
    tracep->declBit(c+140,"luisig", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBit(c+141,"infetch_ready", false,-1);
    ...
    tracep->declBus(c+97,"src1", false,-1, 4,0);
    tracep->declBus(c+98,"src2", false,-1, 4,0);
    tracep->declBus(c+142,"csr", false,-1, 11,0);
    ...
    tracep->declBus(c+143,"csr_choose", false,-1, 1,0);
    ...
    tracep->declBus(c+143,"out", false,-1, 1,0);
    tracep->declBus(c+142,"key", false,-1, 11,0);
    ...
    tracep->declBus(c+144,"lut_out", false,-1, 1,0);
    ...
    tracep->declBit(c+200,"clk", false,-1);
    tracep->declBit(c+201,"rst", false,-1);
    tracep->declBit(c+146,"ew", false,-1);
    tracep->declBit(c+116,"csrrw", false,-1);
    tracep->declBit(c+117,"csrrs", false,-1);
    tracep->declBit(c+103,"ecall", false,-1);
    tracep->declBus(c+143,"csr_choose", false,-1, 1,0);
    ...
    tracep->declBus(c+147,"valid", false,-1, 31,0);
    ...
    tracep->declBus(c+175,"readreg", false,-1, 31,0);
    tracep->declBus(c+205,"len", false,-1, 2,0);
    tracep->declBit(c+148,"signalsig", false,-1);
    tracep->declBus(c+175,"read_u", false,-1, 31,0);
    tracep->declBus(c+206,"read_s", false,-1, 31,0);
    tracep->declBus(c+176,"read_sb", false,-1, 31,0);
    tracep->declBus(c+177,"read_sh", false,-1, 31,0);
    tracep->pushNamePrefix("sext0 ");
    tracep->declBus(c+225,"INPUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+210,"OUTPUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+178,"input_number", false,-1, 7,0);
    tracep->declBus(c+176,"output_number", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("sext1 ");
    tracep->declBus(c+226,"INPUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+210,"OUTPUT_WIDTH", false,-1, 31,0);
    tracep->declBus(c+179,"input_number", false,-1, 15,0);
    ...
    tracep->declArray(c+158,"lut", false,-1, 139,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+217,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+227,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+210,"DATA_LEN", false,-1, 31,0);
    ...
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+171+i*1,"data_list", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+118,(vlSelf->top__DOT__exu0__DOT__aluopcode),5);
    bufp->fullBit(oldp+119,((1U & (~ (IData)(vlSelf->top__DOT__exu0__DOT__alu0__DOT____VdfgTmp_h1dc29214__0)))));
    bufp->fullBit(oldp+120,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__logsig));
    bufp->fullBit(oldp+121,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__shfsig));
    bufp->fullBit(oldp+122,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__sltsig));
    bufp->fullBit(oldp+123,((1U == (IData)(vlSelf->top__DOT__aluop))));
    bufp->fullBit(oldp+124,((3U == (IData)(vlSelf->top__DOT__aluop))));
    bufp->fullBit(oldp+125,((2U == (IData)(vlSelf->top__DOT__aluop))));
    bufp->fullBit(oldp+126,((0U == (IData)(vlSelf->top__DOT__aluop))));
    bufp->fullCData(oldp+127,(((IData)((0x6000U == 
                                        (0x6000U & vlSelf->top__DOT__ifu0__DOT__instbridge)))
                                ? 8U : ((1U & VL_REDXOR_16(
                                                           (0x6000U 
                                                            & vlSelf->top__DOT__ifu0__DOT__instbridge)))
                                         ? 9U : 3U))),4);
    bufp->fullCData(oldp+128,(vlSelf->top__DOT__exu0__DOT__alucontrol0__DOT__IRop),4);
    bufp->fullBit(oldp+129,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__hit));
    bufp->fullCData(oldp+130,((0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge)),7);
    bufp->fullBit(oldp+131,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_I));
    bufp->fullBit(oldp+132,((0x33U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
    bufp->fullBit(oldp+133,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_U));
    bufp->fullIData(oldp+134,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__I_imm),32);
    bufp->fullIData(oldp+135,((0xfffff000U & vlSelf->top__DOT__ifu0__DOT__instbridge)),32);
    bufp->fullIData(oldp+136,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__S_imm),32);
    bufp->fullIData(oldp+137,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__J_imm),32);
    bufp->fullIData(oldp+138,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__B_imm),32);
    bufp->fullBit(oldp+139,(((0x67U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                             | ((0x6fU == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                                | ((0x17U == (0x7fU 
                                              & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                                   | (0x73U == vlSelf->top__DOT__ifu0__DOT__instbridge))))));
    bufp->fullBit(oldp+140,((0x37U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
    bufp->fullBit(oldp+141,(vlSelf->top__DOT__ifu0__DOT__infetch0__DOT__state));
    bufp->fullSData(oldp+142,((vlSelf->top__DOT__ifu0__DOT__instbridge 
                               >> 0x14U)),12);
    bufp->fullCData(oldp+143,(vlSelf->top__DOT__regfile__DOT__csr_choose),2);
    bufp->fullCData(oldp+144,(vlSelf->top__DOT__regfile__DOT__muxcsr__DOT__i0__DOT__lut_out),2);
    bufp->fullBit(oldp+145,(vlSelf->top__DOT__regfile__DOT__muxcsr__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+146,(vlSelf->top__DOT__regfile__DOT____Vcellinp__registers0__ew));
    bufp->fullIData(oldp+147,((0U != vlSelf->top__DOT__ifu0__DOT__instbridge)),32);
    bufp->fullBit(oldp+148,(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__signalsig));
    ...
    __Vtemp_h44c198b2__0[2U] = (vlSelf->top__DOT__regout2 
                                >> 0x1fU);
    bufp->fullWData(oldp+149,(__Vtemp_h44c198b2__0),66);
    bufp->fullQData(oldp+152,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+154,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+156,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+157,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__data_list[1]),32);
    ...
    __Vtemp_hdaf246d3__0[4U] = (vlSelf->top__DOT__res 
                                >> 0x17U);
    bufp->fullWData(oldp+158,(__Vtemp_hdaf246d3__0),140);
    bufp->fullQData(oldp+163,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+165,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+167,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+169,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullIData(oldp+171,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+172,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+173,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+174,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+175,(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg),32);
    bufp->fullIData(oldp+176,((((- (IData)((1U & (vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg 
                                                  >> 7U)))) 
    ...
    bufp->fullCData(oldp+178,((0xffU & vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg)),8);
    bufp->fullSData(oldp+179,((0xffffU & vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg)),16);
