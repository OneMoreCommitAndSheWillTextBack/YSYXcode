    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_ysyxSoCFull__asic__cpu__cpu__ifu0.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.ifu0", "ifu0", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_ysyxSoCFull__asic__lgpio__mgpio__gpio_urt_core.configure(this, name(), "ysyxSoCFull.asic.lgpio.mgpio.gpio_urt_core", "gpio_urt_core", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_ysyxSoCFull__sdram.configure(this, name(), "ysyxSoCFull.sdram", "sdram", -9, VerilatedScope::SCOPE_OTHER);
