...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->top__DOT__pcbridge = vlSelf->top__DOT__branchcontrol0__DOT__npc_tmp;
    }
    ...
    Vtop___024unit____Vdpiimwrap_get_inst_TOP____024unit(vlSelf->top__DOT__pcbridge, vlSelf->__Vfunc_get_inst__1__Vfuncout);
    vlSelf->top__DOT__infetch0__DOT__reg_inst = vlSelf->__Vfunc_get_inst__1__Vfuncout;
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->top__DOT__decoder0__DOT__type_S) {
        ...
        Vtop___024unit____Vdpiimwrap_guest_read_TOP____024unit(vlSelf->top__DOT__res, __Vfunc_guest_read__4__Vfuncout);
        vlSelf->top__DOT__mem0__DOT__readreg = __Vfunc_guest_read__4__Vfuncout;
    }
