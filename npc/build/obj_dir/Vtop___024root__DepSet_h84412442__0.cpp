...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__busy)))) {
        vlSelf->top__DOT__data0__DOT__arviter0__DOT__grant 
            = vlSelf->top__DOT__data0__DOT__arviter0__DOT__next_grant;
        vlSelf->top__DOT__data0__DOT__arviter0__DOT__next_grant 
            = ((2U & ((IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__next_grant) 
                      << 1U)) | (1U & ((IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__next_grant) 
                                       >> 1U)));
    }
    ...
    if ((((IData)(vlSelf->top__DOT__data0__DOT__awvalid_sram) 
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__data0__DOT__rvalid_out = ((IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__grant) 
                                                & (- (IData)(
                                                             (1U 
    ...
    if ((1U & (IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__grant))) {
        vlSelf->top__DOT__data0__DOT__arviter0__DOT__wstrb_out_reg 
            = vlSelf->top__DOT__data0__DOT____Vcellinp__arviter0__wstrb
            [0U];
    }
    if ((2U & (IData)(vlSelf->top__DOT__data0__DOT__arviter0__DOT__grant))) {
        vlSelf->top__DOT__data0__DOT__arviter0__DOT__wstrb_out_reg 
            = vlSelf->top__DOT__data0__DOT____Vcellinp__arviter0__wstrb
            [1U];
    }
