...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+18,((1U & (~ (IData)(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__state)))));
        bufp->chgIData(oldp+19,(vlSelf->top__DOT__ifu0__DOT__instbridge),32);
        bufp->chgBit(oldp+20,((0U != vlSelf->top__DOT__ifu0__DOT__instbridge)));
        ...
        bufp->chgCData(oldp+22,((0x1fU & (vlSelf->top__DOT__ifu0__DOT__instbridge 
                                          >> 0x14U))),5);
        bufp->chgCData(oldp+23,((0x1fU & (vlSelf->top__DOT__ifu0__DOT__instbridge 
                                          >> 7U))),5);
        bufp->chgIData(oldp+24,(vlSelf->top__DOT__imm),32);
        bufp->chgBit(oldp+25,((0x100073U == vlSelf->top__DOT__ifu0__DOT__instbridge)));
        bufp->chgBit(oldp+26,((0x30200073U == vlSelf->top__DOT__ifu0__DOT__instbridge)));
        bufp->chgBit(oldp+27,((0x73U == vlSelf->top__DOT__ifu0__DOT__instbridge)));
        bufp->chgBit(oldp+28,(((IData)(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_I) 
                               | ((0x33U == (0x7fU 
                                  ...
                                  | ((0x6fU == (0x7fU 
                                     ...
                                     | ((IData)(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_U) 
                                        | (3U == (0x7fU 
                                                  & vlSelf->top__DOT__ifu0__DOT__instbridge))))))));
        bufp->chgBit(oldp+29,((0x23U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+30,((3U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+31,(vlSelf->top__DOT__muximm));
        bufp->chgCData(oldp+32,((7U & (vlSelf->top__DOT__ifu0__DOT__instbridge 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+33,(vlSelf->top__DOT__muxsig),3);
        bufp->chgBit(oldp+34,((1U & (vlSelf->top__DOT__ifu0__DOT__instbridge 
                                     >> 0x1eU))));
        bufp->chgBit(oldp+35,((0x63U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+36,((0x6fU == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+37,((0x67U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+38,((0x17U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgCData(oldp+39,(vlSelf->top__DOT__aluop),2);
        bufp->chgCData(oldp+40,(vlSelf->top__DOT__memmask),3);
        bufp->chgBit(oldp+41,(vlSelf->top__DOT__memsextsig));
        bufp->chgCData(oldp+42,(vlSelf->top__DOT__exu0__DOT__aluopcode),5);
        bufp->chgBit(oldp+43,((1U & (~ (IData)(vlSelf->top__DOT__exu0__DOT__alu0__DOT____VdfgTmp_h1dc29214__0)))));
        bufp->chgBit(oldp+44,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__logsig));
        bufp->chgBit(oldp+45,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__shfsig));
        bufp->chgBit(oldp+46,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__sltsig));
        bufp->chgBit(oldp+47,((1U == (IData)(vlSelf->top__DOT__aluop))));
        bufp->chgBit(oldp+48,((3U == (IData)(vlSelf->top__DOT__aluop))));
        bufp->chgBit(oldp+49,((2U == (IData)(vlSelf->top__DOT__aluop))));
        bufp->chgBit(oldp+50,((0U == (IData)(vlSelf->top__DOT__aluop))));
        bufp->chgCData(oldp+51,(((IData)((0x6000U == 
                                          (0x6000U 
                                           & vlSelf->top__DOT__ifu0__DOT__instbridge)))
                                  ? 8U : ((1U & VL_REDXOR_16(
                                                             (0x6000U 
                                                              & vlSelf->top__DOT__ifu0__DOT__instbridge)))
                                           ? 9U : 3U))),4);
        bufp->chgCData(oldp+52,(vlSelf->top__DOT__exu0__DOT__alucontrol0__DOT__IRop),4);
        bufp->chgBit(oldp+53,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__hit));
        bufp->chgCData(oldp+54,((0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge)),7);
        bufp->chgBit(oldp+55,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_I));
        bufp->chgBit(oldp+56,((0x33U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        bufp->chgBit(oldp+57,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__type_U));
        bufp->chgIData(oldp+58,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__I_imm),32);
        bufp->chgIData(oldp+59,((0xfffff000U & vlSelf->top__DOT__ifu0__DOT__instbridge)),32);
        bufp->chgIData(oldp+60,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__S_imm),32);
        bufp->chgIData(oldp+61,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__J_imm),32);
        bufp->chgIData(oldp+62,(vlSelf->top__DOT__idu0__DOT__decoder0__DOT__B_imm),32);
        bufp->chgBit(oldp+63,(((0x67U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                               | ((0x6fU == (0x7fU 
                                             & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                                  | ((0x17U == (0x7fU 
                                                & vlSelf->top__DOT__ifu0__DOT__instbridge)) 
                                     | (0x73U == vlSelf->top__DOT__ifu0__DOT__instbridge))))));
        bufp->chgBit(oldp+64,((0x37U == (0x7fU & vlSelf->top__DOT__ifu0__DOT__instbridge))));
        ...
        bufp->chgIData(oldp+68,(((~ (IData)(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__state)) 
                                 & (0U != vlSelf->top__DOT__ifu0__DOT__instbridge))),32);
        bufp->chgIData(oldp+69,(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg),32);
        bufp->chgIData(oldp+70,(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__read_s),32);
        bufp->chgBit(oldp+71,(vlSelf->top__DOT__wbu0__DOT__mem0__DOT__state));
        ...
        bufp->chgCData(oldp+74,((0xffU & vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg)),8);
        bufp->chgSData(oldp+75,((0xffffU & vlSelf->top__DOT__wbu0__DOT__mem0__DOT__readreg)),16);
    }
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        __Vtemp_h44c198b2__0[2U] = (vlSelf->top__DOT__regout2 
                                    >> 0x1fU);
        bufp->chgWData(oldp+76,(__Vtemp_h44c198b2__0),66);
        bufp->chgQData(oldp+79,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__pair_list[0]),33);
        bufp->chgQData(oldp+81,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__pair_list[1]),33);
        bufp->chgIData(oldp+83,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__data_list[0]),32);
        bufp->chgIData(oldp+84,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__data_list[1]),32);
        ...
        __Vtemp_hdaf246d3__0[4U] = (vlSelf->top__DOT__res 
                                    >> 0x17U);
        bufp->chgWData(oldp+85,(__Vtemp_hdaf246d3__0),140);
        bufp->chgQData(oldp+90,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[0]),35);
        bufp->chgQData(oldp+92,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[1]),35);
        bufp->chgQData(oldp+94,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[2]),35);
        bufp->chgQData(oldp+96,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__pair_list[3]),35);
        bufp->chgIData(oldp+98,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[0]),32);
        bufp->chgIData(oldp+99,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[1]),32);
        bufp->chgIData(oldp+100,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[2]),32);
        bufp->chgIData(oldp+101,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__data_list[3]),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+102,(vlSelf->top__DOT__ifu0__DOT__pcbridge),32);
        bufp->chgIData(oldp+103,(vlSelf->top__DOT__regfile__DOT__rf_csr
                                 [2U]),32);
        bufp->chgIData(oldp+104,(vlSelf->top__DOT__regfile__DOT__rf_csr
                                 [1U]),32);
        bufp->chgIData(oldp+105,(((IData)(4U) + vlSelf->top__DOT__ifu0__DOT__pcbridge)),32);
        bufp->chgBit(oldp+106,(vlSelf->top__DOT__ifu0__DOT__pc_valid));
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgBit(oldp+180,(vlSelf->top__DOT__csrrw));
        bufp->chgBit(oldp+181,(vlSelf->top__DOT__csrrs));
        bufp->chgBit(oldp+182,(vlSelf->top__DOT__ifu0__DOT__infetch0__DOT__state));
        bufp->chgCData(oldp+183,(vlSelf->top__DOT__regfile__DOT__csr_choose),2);
        bufp->chgCData(oldp+184,(vlSelf->top__DOT__regfile__DOT__muxcsr__DOT__i0__DOT__lut_out),2);
        bufp->chgBit(oldp+185,(vlSelf->top__DOT__regfile__DOT____Vcellinp__registers0__ew));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgIData(oldp+186,(vlSelf->top__DOT__npc),32);
        bufp->chgIData(oldp+187,(vlSelf->top__DOT__regwrite),32);
        bufp->chgIData(oldp+188,(vlSelf->top__DOT__regout1),32);
        bufp->chgIData(oldp+189,(vlSelf->top__DOT__regout2),32);
        bufp->chgIData(oldp+190,(vlSelf->top__DOT__res),32);
        ...
        bufp->chgIData(oldp+193,(vlSelf->top__DOT__exu0__DOT__aluarg2),32);
        bufp->chgBit(oldp+194,((0U == vlSelf->top__DOT__res)));
        bufp->chgBit(oldp+195,((vlSelf->top__DOT__res 
                                >> 0x1fU)));
        bufp->chgBit(oldp+196,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__carry_tmp));
        bufp->chgIData(oldp+197,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__logres),32);
        bufp->chgIData(oldp+198,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__addres),32);
        bufp->chgBit(oldp+199,((0U == vlSelf->top__DOT__exu0__DOT__alu0__DOT__addres)));
        bufp->chgIData(oldp+200,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__shfres),32);
        bufp->chgIData(oldp+201,(vlSelf->top__DOT__exu0__DOT__alu0__DOT__sltres),32);
        bufp->chgIData(oldp+202,(vlSelf->top__DOT__exu0__DOT__chosmuximm__DOT__i0__DOT__lut_out),32);
        bufp->chgIData(oldp+203,(vlSelf->top__DOT__regfile__DOT__reg_write_data),32);
        bufp->chgIData(oldp+204,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__lut_out),32);
        bufp->chgBit(oldp+205,(vlSelf->top__DOT__wbu0__DOT__muxpc__DOT__i0__DOT__hit));
    }
    bufp->chgBit(oldp+206,(vlSelf->clk));
    bufp->chgBit(oldp+207,(vlSelf->rst));
    bufp->chgBit(oldp+208,(((~ (IData)(vlSelf->top__DOT__ifu0__DOT__infetch0__DOT__state)) 
