                ...
                if ((1U & (~ (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__state)))) {
                    if ((0x38U == (IData)(vlSelf->ysyxSoCFull__DOT__psram__DOT__inst_buffer))) {
                        ...
                        if (vlSelf->ysyxSoCFull__DOT__psram__DOT__finish) {
                            ...
                            __Vdly__ysyxSoCFull__DOT__psram__DOT__addr_buffer 
                                = (0xffffffU & (vlSelf->ysyxSoCFull__DOT__psram__DOT__addr_buffer 
                                                - (IData)(1U)));
                        }
                    } else {
                        ...
                        if (0x80000002U) { VL_FFLUSH_I(0x80000002U); }
                        VL_WRITEF("[%0t] %%Error: psram.v:114: Assertion failed in %NysyxSoCFull.psram\n",
                                  64,VL_TIME_UNITED_Q(1000),
                                  -9,vlSymsp->name());
                        Verilated::runFlushCallbacks();
                        VL_STOP_MT("/home/ysyx/project/ysyx-workbench/ysyxSoC/perip/psram/psram.v", 114, "");
                    }
                }
            }
